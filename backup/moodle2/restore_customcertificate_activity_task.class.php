...
require_once($CFG->dirroot . '/mod/customcertificate/backup/moodle2/restore_customcertificate_stepslib.php'); // Because it exists (must)

/**
 * certificate restore task that provides all the settings and steps to perform one
 * complete restore of the activity
 */
class restore_customcertificate_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_customcertificate_activity_structure_step('customcertificate_structure', 'customcertificate.xml'));
    }
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('customcertificate', array('intro'), 'customcertificate');
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('customcertificateVIEWBYID', '/mod/customcertificate/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('customcertificateINDEX', '/mod/customcertificate/index.php?id=$1', 'course');
    ...
    static public function define_restore_log_rules_for_course() {
        ...
        $rules[] = new restore_log_rule('customcertificate', 'view all', 'index.php?id={course}', null);
